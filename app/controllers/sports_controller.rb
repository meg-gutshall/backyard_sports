class SportsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @sport.update(sport_params)
        format.html { redirect_to @sport, notice: "Sport was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to sports_path, notice: "Sport was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def sport_params
      params.expect(sport: [ :name, :num_players, :season, :setting, :scoring_method ])
    end
end
